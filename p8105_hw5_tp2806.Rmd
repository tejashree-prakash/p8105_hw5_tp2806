...
* victim_last; victim_first; victim_race; victim_age; victim_sex — demographic info for the victim
* disposition — case status (closed without arrest, closed by arrest, open/no arrest)
