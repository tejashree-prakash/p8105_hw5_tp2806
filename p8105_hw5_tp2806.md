...
This table demonstrates 3 of the 5000 simulation iterations per true mu
...
- victim_last; victim_first; victim_race; victim_age; victim_sex —
  demographic info for the victim
- disposition — case status (closed without arrest, closed by arrest,
  open/no arrest)

#### Summarizing total number of homicides and unsolved homicides by city
...
homicide_summary %>%
  knitr::kable(
    caption = "Total Homicides and Unsolved Homicides for 50 Major US Cities"
  )
```
...
Total Homicides and Unsolved Homicides for 50 Major US Cities
...
|---------:|---------:|----------:|--------:|
|   0.6456 |   0.6276 |    0.6632 |       0 |

Proportion and Confidence Intervals of Unsolved Homicides in Baltimore,
MD
